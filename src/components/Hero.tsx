  ...
  const socialIcons = [
    {
      name: 'TikTok',
      svg: (
        <svg viewBox="0 0 32 32" fill="currentColor" className="w-12 h-12">
    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-primary/5 to-secondary/5">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        >
          ...
          <Button
            size="lg"
            className="relative bg-primary hover:bg-primary/90 text-white rounded-full px-8 py-6 text-lg transition-all duration-300 hover:shadow-xl mb-12"
          >
